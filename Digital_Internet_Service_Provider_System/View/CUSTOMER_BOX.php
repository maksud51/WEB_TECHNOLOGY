...
<head>
	<meta charset="utf-8">
	<title style="text-align:center;">Customer Box</title>
	<style>
		#msg{
		color:red;
		}
	...
	<h2 style="text-align:center;"><u>Customer Box</u></h2>
</head>
<body id="B_Color">
	...
	<br>
	<br>
	<form name="jsform" action="<?php echo htmlspecialchars("../CONTROLLER/CUSTOMER_BOX_A.php"); ?>" method="POST" onsubmit="sendData(this); return false;">
	<fieldset>
	...
	<script>
		function getData() {
			...
			xhttp.open("GET", "../MODEL/CUSTOMER_BOX_M.php");
			xhttp.send();
		}
	</script>
	<div class="footer">
