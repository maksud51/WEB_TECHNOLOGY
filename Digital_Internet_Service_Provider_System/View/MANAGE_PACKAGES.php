...
<head>
	<meta charset="utf-8">
	<title style="text-align:center;">Manage Packages</title>
	...
	<h1 style="text-align:center;" ><u>Manage Packages</u></h1>
</head>
<body  id="B_Color">
	...
	<br>
	<br>
	<button class="button button1"><a href="../CONTROLLER/PACKAGE_USERS1_A.php"><B>User Status</B></a></button><br><br>
	<br>
	<button class="button button1"><a href="../VIEW/USER_ACTIVITY.php"><B>User Activity</B></a></button><br><br><br>

	<button class="button button1"><a href="../VIEW/MANAGER_BOX.php"><B>Manager Box</B></a></button><br><br><br>
	<div class="footer">
