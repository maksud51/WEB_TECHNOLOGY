            ...
            if ($response) {
                ...
                if ($data->num_rows > 0) 
                {
                  $res=true;
                    ...
                    $sql2 = "UPDATE control SET customer_request =? WHERE name = ?";
            $stmt2 = $connection->prepare($sql2);
            $stmt2->bind_param("ss",$CUSTOMER_REQUEST, $NAME );
             $NAME=$USERNAME;
             $CUSTOMER_REQUEST=$_POST["package_name"];;
               $response2 = $stmt2->execute(); 
                ...
                {
                    $res=false;
                     echo "You need to buy a package First ";
